...
Gostei de como o padrão composite pode ser utilizado para validações, pois são utilizadas na maioria dos projetos. Tratar de um objeto ou de uma estrutura com vários objetos ordenados de forma hierárquica da mesma maneira auxilia muito na criação de objetos complexos.
