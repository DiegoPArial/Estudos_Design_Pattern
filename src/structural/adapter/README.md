...
Muito útil o design pattern de adapter, pelas explicações ele deve estar presente em vários tipos de códigos diferentes, seja para auxiliar em uma validação ou utilizar códigos de terceiros sem depender do mesmo. Caso seja necessário alterar alguma informação do código terceirizado, a alteração será apenas na parte do adapter.
