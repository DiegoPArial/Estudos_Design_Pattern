...
Dentre todos os design patterns, este foi um dos que achei mais complexo o entendimento, pois existem várias maneiras de utilizá-lo e o código implementado eu achei difícil, mas com a prática desejo obter mais conhecimento sobre proxy e suas variações, pois podem ser muito úteis no desenvolvimento de um sistema.
