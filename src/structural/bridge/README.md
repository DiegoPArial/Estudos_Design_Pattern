...
Muito parecido com o adapter, mas com uma diferença simples, adapter é utilizado após a projeção de tudo, e o bridge é utilizado antes que existam. Saber diferenciar e utilizar de maneira correta será de grande ajuda em um projeto.
