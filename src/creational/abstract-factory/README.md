...
Baseado nos exemplos descritos abaixo, a separação das classes em família facilita muito o entendimento sobre o assunto, pois sempre serão compatíveis entre si, e caso seja preciso adicionar mais classes, o abstract factory segue o princípio de aberto e fechado, adicionando mais classes sem alterar as já existentes.
...
Imagine essa hierarquia descrita assim:
...
Observação importante: objetos criados por fábricas tendem a ser chamados de "Product" (produto). Veja os diagramas na pasta "diagramas" para melhor entendimento.
