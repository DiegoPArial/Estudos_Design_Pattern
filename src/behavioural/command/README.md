...
Muito interessante associar este design pattern a um controle remoto, pois ele dá o comando, mas quem executa é a TV. Ele é simples de entender, além de ser uma versão orientada a objetos para funções de callback.
