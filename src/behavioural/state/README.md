...
Essa ilusão de que o objeto mudou de classe quando seu comportamento interno muda é muito interessante, em status de pagamento ou em outras opções este design pattern pode ser muito utilizado. Ele é simples de entender e sua implementação não é tão complexa.
