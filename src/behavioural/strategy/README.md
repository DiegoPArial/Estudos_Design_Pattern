...
Um design pattern muito útil que define incontáveis estratégias, seja para comércio, como a aplicação de descontos, ou outra área em que separa a regra de negócio de algoritmos complexos. Ele segue o princípio de aberto e fechado, o que é muito bom pois não tem necessidade de alteração de código, apenas extensão.
